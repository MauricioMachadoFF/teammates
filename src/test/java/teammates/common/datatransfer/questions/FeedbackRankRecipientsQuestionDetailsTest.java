...
public class FeedbackRankRecipientsQuestionDetailsTest extends BaseTestCase {
        ...
        public void tesValidateResponsesDetails() {
                ...
                expectedErrors = Arrays.asList(
                                String.format(minOptionErrorStr,
                                                feedbackRankRecipientsQuestionDetails.minOptionsToBeRanked));
                assertEquals(expectedErrors, actualErrors);
                ...
                expectedErrors = Arrays.asList(
                                String.format(maxOptionErrorStr,
                                                feedbackRankRecipientsQuestionDetails.maxOptionsToBeRanked));
                assertEquals(expectedErrors, actualErrors);
                ...
                expectedErrors = Arrays.asList(
                                String.format(duplicateErrorStr, response2.getAnswer()),
                                String.format(maxOptionErrorStr,
                                                feedbackRankRecipientsQuestionDetails.getMaxOptionsToBeRanked()));
                assertEquals(expectedErrors, actualErrors);
                ...
                expectedErrors = Arrays.asList(
                                ...
                                String.format(minOptionErrorStr,
                                                feedbackRankRecipientsQuestionDetails.getMinOptionsToBeRanked()));
                assertEquals(expectedErrors, actualErrors);
        ...
        @Test
        public void testValidateResponsesDetailsDuplicatedRankAndMinimalRankNotAchieved() {
                FeedbackRankRecipientsQuestionDetails feedbackRankRecipientsQuestionDetails = new FeedbackRankRecipientsQuestionDetails();
                Integer mockAnswerValue = 1;
                Integer minOptionsToBeRanked = 3;
                feedbackRankRecipientsQuestionDetails.setMinOptionsToBeRanked(minOptionsToBeRanked);

                FeedbackRankRecipientsResponseDetails response1 = new FeedbackRankRecipientsResponseDetails();
                FeedbackRankRecipientsResponseDetails response2 = new FeedbackRankRecipientsResponseDetails();
                String duplicateErrorStr = "Duplicate rank " + mockAnswerValue + " in question";
                String minimalRankNotAchievedErrorStr = "You must rank at least " +
                                minOptionsToBeRanked + " options.";
                List<String> expectedErrors = Arrays.asList(duplicateErrorStr,
                                minimalRankNotAchievedErrorStr);

                response1.setAnswer(mockAnswerValue);
                response2.setAnswer(mockAnswerValue);
                List<String> actualErrors = feedbackRankRecipientsQuestionDetails.validateResponsesDetails(
                                Arrays.asList(response1, response2), 2);
        ...
        @Test
        public void testValidateResponseDetailsInvalidRankAndMaximalRankSurpassed() {
                FeedbackRankRecipientsQuestionDetails feedbackRankRecipientsQuestionDetails = new FeedbackRankRecipientsQuestionDetails();
                Integer maxOptionsToBeRanked = 1;
                Integer response1Answer = 2;
                Integer response2Answer = 1;
                feedbackRankRecipientsQuestionDetails.setMaxOptionsToBeRanked(maxOptionsToBeRanked);

                FeedbackRankRecipientsResponseDetails response1 = new FeedbackRankRecipientsResponseDetails();
                FeedbackRankRecipientsResponseDetails response2 = new FeedbackRankRecipientsResponseDetails();

                String invalidRankStr = "Invalid rank " + response1Answer + " in question";
                String maximalRankedSurpassedErrorStr = "You can rank at most " +
                                maxOptionsToBeRanked + " options.";
                List<String> expectedErrors = Arrays.asList(invalidRankStr,
                                maximalRankedSurpassedErrorStr);

                response1.setAnswer(response1Answer);
                response2.setAnswer(response2Answer);
                List<String> actualErrors = feedbackRankRecipientsQuestionDetails
                                .validateResponsesDetails(Arrays.asList(response1, response2), 1);

                assertEquals(expectedErrors, actualErrors);
        }

        @Test
        public void testValidateResponseDetailsNoErrorsMessage() {
                FeedbackRankRecipientsQuestionDetails feedbackRankRecipientsQuestionDetails = new FeedbackRankRecipientsQuestionDetails();
                feedbackRankRecipientsQuestionDetails.setAreDuplicatesAllowed(true);
                feedbackRankRecipientsQuestionDetails.setMinOptionsToBeRanked(1);
                feedbackRankRecipientsQuestionDetails.setMaxOptionsToBeRanked(4);
                FeedbackRankRecipientsResponseDetails response1 = new FeedbackRankRecipientsResponseDetails();
                ...
                response1.setAnswer(1);
                List<String> errors = feedbackRankRecipientsQuestionDetails
                                .validateResponsesDetails(Arrays.asList(response1), 1);
        ...
        public void testValidateGiverRecipientVisibility() {
                ...
                assertEquals("", feedbackRankRecipientsQuestionDetails
                                .validateGiverRecipientVisibility(feedbackQuestionAttributes));
        }
}
